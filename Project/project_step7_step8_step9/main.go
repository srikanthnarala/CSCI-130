/********project step_5, step_6, step_7: 
 STEP 7 - Allow the user to login. Store the information about whether 
 or not a user is logged in in both the "user" data type you created and in the 
 cookie. 
 STEP 8 - Allow the user to logout. Show a log-in button when the user 
 is not logged-in. Show a log-out button only when the user is logged in.
 STEP 9 - A user should not be able to access the form to upload user 
